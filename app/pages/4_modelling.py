...
def about():
    ...
    st.warning(
        "I'm planning to provide some time series modelling that shed lights on what tends to influence both pledge and account growth. Bear with me, this will come in a future version of the app."
    )
    ...
    with middle_right:
        st.header(
            "Overview",
            help="The data used in modelling is at daily level. Here we aggregate it to weekly level for convenience.",
        )
